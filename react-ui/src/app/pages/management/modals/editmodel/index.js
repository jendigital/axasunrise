...
class EditModel extends Component {
    ...
    render() {
        ...
        return (
            <div id='modelEdit'>
                <div className={this.state.editingModel ? 'active model_action' : 'model_action'} onClick={this.editModel}>
                    EDIT
                </div>
                <Modal
                    isOpen={this.state.editingModel}
                    onRequestClose={this.closeEditModel}
                    style={customStyles}
                    contentLabel="Model Edition"
                >
                    <div className='modal-container'>
                        <div className='modal-title'>
                            Model edition <span className='close' onClick={this.closeEditModel}>X</span>
                        </div>
                        <form>
