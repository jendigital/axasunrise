...
class VersionModel extends Component {
    constructor(props) {
        super(props);
        ...
        this.versionModel = this.versionModel.bind(this);
        this.closeVersionModel = this.closeVersionModel.bind(this);
    ...
    render() {
        ...
        return (
            <div id='modelVersion'>
                <div className={this.state.creatingModel ? 'active model_action' : 'model_action'} onClick={this.versionModel}>
                    VERSION
                </div>
                <Modal
                    isOpen={this.state.creatingModel}
                    onRequestClose={this.closeVersionModel}
                    style={customStyles}
                    contentLabel="Model Creation"
                >
                    <div className='modal-container'>
                        <div className='modal-title'>
                            Model creation <span className='close' onClick={this.closeVersionModel}>X</span>
                        </div>
                        <form>
...
export default connect(mapStateToProps)(VersionModel)
